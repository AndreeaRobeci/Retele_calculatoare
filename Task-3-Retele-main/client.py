...
class FTPClient:
    ...
    def rename_file(self):
        ...
        choice = input("\nEnter file number or name to rename: ").strip()
    ...
    def read_file(self):
        ...
        choice = input("\nEnter file number or name to read: ").strip()
        ...
        if response['status'] == 'error':
            ...
            print("-" * 40)
            print(response.get('content', response['message']))
            print("-" * 40)
    ...
    def download(self):
        ...
        if response['status'] == 'error':
            ...
            try:
                # Save file to local_files directory
                filepath = os.path.join(LOCAL_FILES_DIR, filename)
    ...
    def edit_file(self):
        ...
        # Ask user to select a file
        choice = input("\nEnter file number or name to edit: ").strip()
    ...
    def see_file_operation_history(self):
        ...
        # Ask user to select a file
        choice = input("\nEnter file number or name to see history: ").strip()
        ...
        # Send history command to server
        command = {
        ...
        if response['status'] == 'error':
            ...
            print(f"✓ File operation history:")
            print("-" * 40)
            print(response.get('history', response['message']))
            print("-" * 40)
